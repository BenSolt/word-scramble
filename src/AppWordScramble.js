...
const arr = [
    ...
    // { id: 18, letter: randomLetrs(1), state: "tileStart" }, 
    // { id: 19, letter: randomLetrs(1), state: "tileStart" }, { id: 20, letter: randomLetrs(1), state: "tileStart" }, 
    // { id: 21, letter: randomLetrs(1), state: "tileStart" }, { id: 22, letter: randomLetrs(1), state: "tileStart" }, 
    // { id: 23, letter: randomLetrs(1), state: "tileStart" }, { id: 24, letter: randomLetrs(1), state: "tileStart" }, 

    // { id: 25, letter: randomLetrs(1), state: "tileStart" }, { id: 26, letter: randomLetrs(1), state: "tileStart" }, 
    // { id: 27, letter: randomLetrs(1), state: "tileStart" }, { id: 28, letter: randomLetrs(1), state: "tileStart" },
    // { id: 29, letter: randomLetrs(1), state: "tileStart" }, { id: 30, letter: randomLetrs(1), state: "tileStart" }, 
